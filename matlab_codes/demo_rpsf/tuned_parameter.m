...
% 0 is without
%==================================================================
fileID = fopen('15KL-NC_step.txt','a');
% for p1 =  0.01 % 0.001:0.003:0.008
%     for p2 = 750 % 300:150:900
%         for p3 = 0.1 % 0.02:0.08:0.4

a = 80.0000;
for mu = 0.001:0.0005:0.002
for nu = 0.01:0.01:0.04
for lambda = 40:40:120
...
save('result_15L2-NC_step.mat','a','mu','nu','lambda',...
