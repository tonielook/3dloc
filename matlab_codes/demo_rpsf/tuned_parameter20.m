...
% 0 is without
%==================================================================
fileID = fopen('20KL-NC_step.txt','a');
...
a = 80.0000;
for mu = 0.002:0.001:0.01
for nu = 0.015:0.005:0.03
for lambda = 120:40:120
...
save('result_20KL-NC_step.mat','a','mu','nu','lambda',...
