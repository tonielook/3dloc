#!/bin/bash
set -x
declare -a cps=("70L5-012111-nTrain9000-lr0.001-Epoch190-batchSize10-D250-cnn_residual/checkpoint_best_loss" 
                "60L5-012209-nTrain9000-lr0.001-Epoch190-batchSize10-D250-cnn_residual/checkpoint_best_loss" 
                "50L5-012510-nTrain9000-lr0.001-Epoch190-batchSize10-D250-cnn_residual/checkpoint_best_loss" 
)
# pts=(5 25 45)
