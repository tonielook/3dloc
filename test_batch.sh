#!/bin/bash
set -x
# declare -a cps=("1118-nTrain2500-lr0.0005-Epoch190-batchSize8-D250-cnn_residual/checkpoint_best_loss" 
#                 "1104-nTrain2499-lr0.0005-Epoch190-batchSize8-D250-cnn_residual/checkpoint_best_loss" 
#                 "1117-nTrain2500-lr0.0005-Epoch190-batchSize8-D250-cnn_residual/checkpoint_best_loss" 
# )
# pts=(5 25 45)

declare -a cps=("112522-nTrain9000-lr0.0005-Epoch190-batchSize8-D250-cnn_residual/checkpoint_best_loss")
