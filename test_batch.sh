#!/bin/bash
set -x
declare -a cps=("1120-nTrain2000-lr0.0005-Epoch190-batchSize8-D250-cnn_residual-resume/checkpoint_best_loss" 
                "1120-nTrain2000-lr0.0005-Epoch190-batchSize8-D250-cnn_residual-resume/checkpoint_latest" 
                "1120-nTrain1000-lr0.0005-Epoch190-batchSize8-D250-cnn_residual-resume/checkpoint_best_loss" 
                "1120-nTrain1000-lr0.0005-Epoch190-batchSize8-D250-cnn_residual-resume/checkpoint_latest" 
                )
# pts=(5 25 45)
